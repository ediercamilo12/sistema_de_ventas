<div style="margin-bottom: 1em;">
    <a href="{{  route('customers.index') }}">Product list</a>
</div>
...
<form action="{{  route('customers.edit', $customers) }}" method="post">
    @csrf
    <div style="margin-bottom: 1em;">
        <label for="name">Name</label>
        <input type="text" name="name" id="name" placeholder="Enter category" value="{{  $customers->name }}">
        @error('name')
